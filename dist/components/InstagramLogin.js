...
class InstagramLogin extends react_1.Component {
    ...
    componentDidMount() {
        if (this.props.implicitAuth) {
            ...
            this.exchangeCodeForToken((0, utils_1.inGetQueryVariable)("code"));
        }
        else if (window.location.search.includes("error")) {
            this.props.onFailure({
                error: (0, utils_1.inGetQueryVariable)("error"),
                error_reason: (0, utils_1.inGetQueryVariable)("error_reason"),
                error_description: (0, utils_1.inGetQueryVariable)("error_description"),
            });
        }
    }
    onBtnClick() {
