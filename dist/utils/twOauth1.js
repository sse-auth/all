...
const twSingature_1 = require("./twSingature");
...
const obtainOauthRequestToken = (_a) => __awaiter(void 0, [_a], void 0, function* ({ consumerKey, consumerSecret, callbackUrl, method, apiUrl, }) {
    const oauthSignature = (0, twSingature_1.requestTokenSignature)({
        method,
        apiUrl,
        callbackUrl,
        consumerKey,
...
const obtainOauthAccessToken = (_b) => __awaiter(void 0, [_b], void 0, function* ({ consumerKey, consumerSecret, oauthToken, oauthVerifier, method, apiUrl, }) {
    const oauthSignature = (0, twSingature_1.accessTokenSignature)({
        method,
        apiUrl,
        consumerKey,
        consumerSecret,
...
//# sourceMappingURL=twOauth1.js.map