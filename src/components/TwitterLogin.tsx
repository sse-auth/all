...
import { TwitterLoginProps, TwitterLoginState, TwitterLoginButtonProps } from "../interface";
import { openWindow, observeWindow } from "../utils/twWindow";
import {
  obtainOauthRequestToken,
  obtainOauthAccessToken,
} from "../utils/twOauth1";

const TwitterLoginButton: React.FunctionComponent<TwitterLoginButtonProps> = ({
    buttonTheme,
    buttonClassName,
    onClick,
  }) => {
